...
const extractTextFromChildren = (children: React.ReactNode): string => {
  ...
  throw new Error("ScrollAndSwapText: Children must be a string or a React element containing a string. " + "Complex nested structures are not supported.");
};
...
const ScrollAndSwapText = ({
  ...
  return (
    <ElementTag className={cn("flex overflow-hidden relative items-center justify-center p-0", className)} ref={ref} {...props}>
