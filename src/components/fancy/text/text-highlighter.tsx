...
import { ElementType, forwardRef, useEffect, useImperativeHandle, useMemo, useRef, useState } from "react";
...
export const TextHighlighter = forwardRef<TextHighlighterRef, TextHighlighterProps>(
  (
    ...
    const shouldAnimate =
      triggerType === "hover" ? isHovered : triggerType === "inView" ? isInView : triggerType === "ref" ? isAnimating : triggerType === "auto" ? true : false;
