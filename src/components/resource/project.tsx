    ...
    items: [
      {
        ...
        default: { code: true, shopify: true, imweb: true, cafe24: true, framer: false, webflow: true, wordpress: false, bubble: true },
      ...
      },
      {
        ...
        default: { code: false, shopify: true, imweb: true, cafe24: true, framer: false, webflow: true, wordpress: false, bubble: true },
        view: { code: true, shopify: true, imweb: true, cafe24: true, framer: true, webflow: true, wordpress: true, bubble: true },
      },
      {
        icon: "👋",
    ...
    items: [
      {
        ...
        default: { code: false, shopify: false, imweb: false, cafe24: false, framer: false, webflow: false, wordpress: false, bubble: false },
        view: { code: true, shopify: true, imweb: false, cafe24: false, framer: false, webflow: true, wordpress: true, bubble: true },
      },
      {
        icon: "📢",
        title: "관리자 푸시 알림",
    ...
    items: [
      {
        ...
        default: { code: false, shopify: false, imweb: true, cafe24: true, framer: false, webflow: true, wordpress: true, bubble: false },
        view: { code: true, shopify: true, imweb: true, cafe24: true, framer: true, webflow: true, wordpress: true, bubble: true },
      },
      {
        icon: "📄",
      ...
      },
      {
        ...
        default: { code: false, shopify: false, imweb: true, cafe24: true, framer: true, webflow: true, wordpress: true, bubble: false },
        view: { code: true, shopify: true, imweb: true, cafe24: true, framer: true, webflow: true, wordpress: true, bubble: true },
      },
      {
        icon: "🎥",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        default: { code: false, shopify: false, imweb: false, cafe24: false, framer: false, webflow: false, wordpress: false, bubble: false },
        view: { code: true, shopify: true, imweb: false, cafe24: true, framer: true, webflow: true, wordpress: true, bubble: true },
      },
    ],
  },
];
