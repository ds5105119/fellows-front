    ...
    items: [
      {
        ...
        view: {
          code: true,
          nocode: { imweb: true, framer: false, webflow: true, wordpress: true, bubble: true, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: false },
        },
        alwaysOn: {
          code: false,
          nocode: { imweb: true, framer: false, webflow: false, wordpress: false, bubble: false, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: false },
        },
        default: {
          code: true,
          nocode: { imweb: true, framer: false, webflow: false, wordpress: false, bubble: true, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: false },
        },
      },
      {
        ...
        alwaysOn: {
          code: false,
          nocode: { imweb: false, framer: false, webflow: false, wordpress: false, bubble: false, other: false },
          shop: { shopify: false, imweb: false, cafe24: false, other: false },
        },
        default: {
          code: false,
          nocode: { imweb: false, framer: false, webflow: false, wordpress: false, bubble: false, other: false },
      ...
      },
      {
        ...
        view: {
          code: true,
          nocode: { imweb: true, framer: false, webflow: false, wordpress: false, bubble: true, other: false },
          shop: { shopify: false, imweb: true, cafe24: true, other: false },
        },
        alwaysOn: {
          code: false,
          nocode: { imweb: false, framer: false, webflow: false, wordpress: false, bubble: false, other: false },
      ...
      },
      {
        ...
        default: {
          code: false,
          nocode: { imweb: true, framer: false, webflow: true, wordpress: false, bubble: true, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: false },
        },
      },
      {
        ...
        default: {
          code: false,
          nocode: { imweb: true, framer: false, webflow: true, wordpress: false, bubble: false, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: false },
        },
      },
      {
        ...
        view: {
          code: true,
          nocode: { imweb: false, framer: false, webflow: false, wordpress: false, bubble: true, other: false },
          shop: { shopify: false, imweb: false, cafe24: false, other: false },
        },
        alwaysOn: {
          code: false,
    ...
    items: [
      {
        ...
        view: {
          code: true,
          nocode: { imweb: true, framer: false, webflow: false, wordpress: true, bubble: true, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: false },
        },
        alwaysOn: {
          code: false,
          nocode: { imweb: false, framer: false, webflow: false, wordpress: false, bubble: false, other: false },
          shop: { shopify: false, imweb: false, cafe24: true, other: false },
        },
        default: {
          code: false,
          nocode: { imweb: false, framer: false, webflow: false, wordpress: false, bubble: false, other: false },
          shop: { shopify: true, imweb: false, cafe24: true, other: false },
        },
      },
      {
        icon: "⚙️",
      ...
      },
      {
        ...
        view: {
          code: true,
          nocode: { imweb: false, framer: false, webflow: false, wordpress: true, bubble: true, other: false },
          shop: { shopify: false, imweb: false, cafe24: false, other: false },
        },
        alwaysOn: {
          code: false,
      ...
      },
      {
        ...
        view: {
          code: true,
          nocode: { imweb: true, framer: true, webflow: true, wordpress: true, bubble: true, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: false },
        },
        alwaysOn: {
          code: false,
    ...
    items: [
      {
        icon: "📝",
        title: "작성 및 삭제하기",
        description: "사용자가 게시물, 댓글 등 콘텐츠를 생성하고 삭제할 수 있어요.",
        view: {
          code: true,
          nocode: { imweb: true, framer: true, webflow: true, wordpress: true, bubble: true, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: false },
        ...
        alwaysOn: {
          code: false,
          nocode: { imweb: true, framer: false, webflow: true, wordpress: true, bubble: false, other: false },
          shop: { shopify: false, imweb: true, cafe24: true, other: false },
        },
        default: {
          code: true,
      ...
      },
      {
        icon: "📄",
        title: "내가 작성한 목록",
        description: "사용자가 자신이 작성한 게시물이나 댓글을 모아볼 수 있어요.",
        view: {
          code: true,
          nocode: { imweb: true, framer: true, webflow: true, wordpress: true, bubble: true, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: false },
      ...
      },
      {
        icon: "✏️",
        title: "콘텐츠 수정",
        description: "작성한 콘텐츠의 내용을 다시 수정할 수 있어요.",
        view: {
          code: true,
          nocode: { imweb: true, framer: true, webflow: true, wordpress: true, bubble: true, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: false },
      ...
      },
      {
        icon: "✒️",
        title: "에디터 사용",
        description: "글꼴, 서식, 이미지 첨부 등 다양한 편집 기능을 제공하는 에디터를 사용할 수 있어요.",
        view: {
          code: true,
          nocode: { imweb: true, framer: true, webflow: true, wordpress: true, bubble: true, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: false },
      ...
      },
      {
        icon: "🖼️",
        title: "사진 업로드",
        description: "게시물에 사진이나 이미지를 첨부할 수 있어요.",
        view: {
          code: true,
          nocode: { imweb: true, framer: true, webflow: true, wordpress: true, bubble: true, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: false },
        ...
        alwaysOn: {
          code: false,
          nocode: { imweb: true, framer: true, webflow: true, wordpress: true, bubble: false, other: false },
          shop: { shopify: false, imweb: true, cafe24: true, other: false },
        },
        default: {
          code: false,
      ...
      },
      {
        icon: "🎥",
        title: "동영상 업로드",
        description: "게시물에 동영상 파일을 직접 올리거나 링크를 임베드할 수 있어요.",
        view: {
          code: true,
          nocode: { imweb: true, framer: true, webflow: true, wordpress: true, bubble: true, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: false },
      ...
      },
      {
        icon: "📎",
        title: "파일 업로드",
        description: "문서, 압축 파일 등 다양한 형식의 파일을 첨부할 수 있어요.",
        view: {
          code: true,
          nocode: { imweb: true, framer: true, webflow: true, wordpress: true, bubble: true, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: false },
      ...
      },
      {
        icon: "🗄",
        title: "스크랩",
        description: "나중에 다시보고 싶은 콘텐츠를 스크랩 할 수 있어요.",
        view: {
          code: true,
          nocode: { imweb: false, framer: false, webflow: false, wordpress: false, bubble: true, other: false },
          shop: { shopify: false, imweb: false, cafe24: false, other: false },
      ...
      },
      {
        icon: "🚩",
        title: "게시물 신고",
        description: "부적절하거나 규정에 위배되는 게시물을 신고할 수 있어요.",
        view: {
          code: true,
          nocode: { imweb: false, framer: false, webflow: false, wordpress: false, bubble: true, other: false },
          shop: { shopify: false, imweb: false, cafe24: false, other: false },
    ...
    items: [
      {
        ...
        view: {
          code: true,
          nocode: { imweb: false, framer: false, webflow: false, wordpress: false, bubble: true, other: false },
          shop: { shopify: true, imweb: true, cafe24: true, other: true },
        },
        alwaysOn: {
          code: false,
          nocode: { imweb: false, framer: false, webflow: false, wordpress: false, bubble: true, other: false },
    ...
    items: [
      ...
      },
      {
        ...
        view: {
          code: true,
          nocode: { imweb: false, framer: false, webflow: false, wordpress: false, bubble: true, other: false },
          shop: { shopify: true, imweb: false, cafe24: false, other: false },
        },
        alwaysOn: {
          code: false,
          nocode: { imweb: false, framer: false, webflow: false, wordpress: false, bubble: false, other: false },
...
export const stepsMeta: {
...
}[] = [
  {
    ...
    fields: ["custom_project_title", "custom_project_summary", "custom_platforms", "custom_readiness_level", "custom_project_method", "custom_nocode_platform"],
    uiRequiredFields: [
      "custom_project_title",
      "custom_project_summary",
      "custom_platforms",
      "custom_readiness_level",
      "custom_project_method",
      "custom_nocode_platform",
    ],
  },
  {
    number: 2,
...
export const NOCODE_PLATFORM_MAPPING: Record<NoCodePlatform, { title: string; description: string }> = {
  ...
  other: {
    title: "그 외",
    description: "그 외 노코드 플랫폼이 필요하다면 별도로 기능을 구성할 수 있어요",
  },
};
