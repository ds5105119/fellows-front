...
export default function AnimatedGradientButton({ icon = "🎉", text, href, ...props }: AnimatedGradientButtonProps) {
  const children = (
    <>
      <span
        className={cn(
      ...
      <AnimatedGradientText className="text-sm font-semibold">{text}</AnimatedGradientText>
