      ...
      {isExpanded && (
        <div className="px-4 pb-4 space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-600 whitespace-pre-wrap">{welfare.service_conditions}</p>
          </div>
          <div className="space-y-2">
            <h3 className="font-medium">신청방법</h3>
            <p className="text-sm text-gray-600 whitespace-pre-wrap">{welfare.apply_method}</p>
          </div>
          {welfare.document && (
            <div className="space-y-2">
              <h3 className="font-medium">필요서류</h3>
              <p className="text-sm text-gray-600 whitespace-pre-wrap">{welfare.document}</p>
            </div>
          )}
        </div>
      )}
