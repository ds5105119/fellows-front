...
export default function WorkMain4() {
  ...
  const desktop0ScaleY = useTransform(sectionBProgress, [desktop0Start, desktop0Start + 0.025, desktop0Start + 0.04], [0, 1.3, 1]);
  ...
  const desktop1ScaleY = useTransform(sectionBProgress, [desktop1Start, desktop1Start + 0.025, desktop1Start + 0.04], [0, 1.3, 1]);
  ...
  const desktop2ScaleY = useTransform(sectionBProgress, [desktop2Start, desktop2Start + 0.025, desktop2Start + 0.04], [0, 1.3, 1]);
  ...
  const desktop3ScaleY = useTransform(sectionBProgress, [desktop3Start, desktop3Start + 0.025, desktop3Start + 0.04], [0, 1.3, 1]);
  ...
  const desktop4ScaleY = useTransform(sectionBProgress, [desktop4Start, desktop4Start + 0.025, desktop4Start + 0.04], [0, 1.3, 1]);
  ...
  const desktop5ScaleY = useTransform(sectionBProgress, [desktop5Start, desktop5Start + 0.025, desktop5Start + 0.04], [0, 1.3, 1]);
  ...
  const desktop6ScaleY = useTransform(sectionBProgress, [desktop6Start, desktop6Start + 0.025, desktop6Start + 0.04], [0, 1.3, 1]);
  ...
  const desktop7ScaleY = useTransform(sectionBProgress, [desktop7Start, desktop7Start + 0.025, desktop7Start + 0.04], [0, 1.3, 1]);
  ...
  const desktop8ScaleY = useTransform(sectionBProgress, [desktop8Start, desktop8Start + 0.025, desktop8Start + 0.04], [0, 1.3, 1]);
  ...
  const desktop9ScaleY = useTransform(sectionBProgress, [desktop9Start, desktop9Start + 0.025, desktop9Start + 0.04], [0, 1.3, 1]);
  ...
  const desktop10ScaleY = useTransform(sectionBProgress, [desktop10Start, desktop10Start + 0.025, desktop10Start + 0.04], [0, 1.3, 1]);
  ...
  const desktop11ScaleY = useTransform(sectionBProgress, [desktop11Start, desktop11Start + 0.025, desktop11Start + 0.04], [0, 1.3, 1]);
  ...
  const desktop12ScaleY = useTransform(sectionBProgress, [desktop12Start, desktop12Start + 0.025, desktop12Start + 0.04], [0, 1.3, 1]);
  ...
  const mobile0ScaleY = useTransform(sectionBProgress, [mobile0Start, mobile0Start + 0.025, mobile0Start + 0.04], [0, 1.3, 1]);
  ...
  const mobile1ScaleY = useTransform(sectionBProgress, [mobile1Start, mobile1Start + 0.025, mobile1Start + 0.04], [0, 1.3, 1]);
  ...
  const mobile2ScaleY = useTransform(sectionBProgress, [mobile2Start, mobile2Start + 0.025, mobile2Start + 0.04], [0, 1.3, 1]);
  ...
  const mobile3ScaleY = useTransform(sectionBProgress, [mobile3Start, mobile3Start + 0.025, mobile3Start + 0.04], [0, 1.3, 1]);
  ...
  const mobile4ScaleY = useTransform(sectionBProgress, [mobile4Start, mobile4Start + 0.025, mobile4Start + 0.04], [0, 1.3, 1]);
  ...
  const mobile5ScaleY = useTransform(sectionBProgress, [mobile5Start, mobile5Start + 0.025, mobile5Start + 0.04], [0, 1.3, 1]);
  ...
  const mobile6ScaleY = useTransform(sectionBProgress, [mobile6Start, mobile6Start + 0.025, mobile6Start + 0.04], [0, 1.3, 1]);
  ...
  return (
    <div className="flex flex-col" ref={containerRef}>
      <section className="w-full h-48 bg-white relative"></section>
      ...
      <section className="w-full h-dvh bg-zinc-900 relative z-20" ref={sectionBRef}>
        ...
        <div className="flex items-center justify-center h-full">
          <div className="text-center">
            <h1 className="text-6xl md:text-8xl font-bold text-white mb-8">SECTION B</h1>
          </div>
        </div>
      </section>
    </div>
