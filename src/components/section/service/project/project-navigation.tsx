...
export default function ProjectNavigation() {
  ...
  return (
    <div className="sticky w-full top-12 md:top-16 flex items-center justify-between min-h-12 h-12 md:min-h-16 md:h-16 px-4 md:px-6 bg-background z-20 border-b border-b-sidebar-border">
