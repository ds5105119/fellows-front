...
export default function ProjectNavigation() {
  ...
  const tabMapping: Record<"프로젝트", ""> & Record<"계약서", "contract"> = { 프로젝트: "", 계약서: "contract" };

  const handleTabChange = (tab: "프로젝트" | "계약서") => {
    router.push("/service/project/" + tabMapping[tab]);
  };

  const tab = pathname.startsWith("/service/project/contract") ? "프로젝트" : pathname.startsWith("/service/project") ? "프로젝트" : "";
