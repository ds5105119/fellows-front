  ...
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="col-span-1 md:pr-4 aspect-[7/9] md:aspect-[8/9] mb-10 md:mb-0">
        <div className="w-full h-full bg-white rounded-3xl flex items-end justify-center overflow-hidden relative">
      ...
      <div className="col-span-1 md:pl-4 aspect-[7/9] md:aspect-[8/9] mb-10 md:mb-0 ">
        <div className="w-full h-full bg-emerald-200 rounded-3xl flex items-end justify-center overflow-hidden relative">
          <div className="absolute top-10 left-10 flex flex-col space-y-1.5">
            <div className="flex flex-col space-y-2">
