...
export default function MainSection3() {
  ...
  const highlightClass = "rounded-[0.3em] px-px font-bold";
  ...
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2">
      ...
      <div
        ...
        className="relative col-span-1 md:mr-5 mb-8 md:mb-0 cursor-none"
              ...
              >
                <div className="max-w-md mx-auto px-8 p-0 text-white">
                  ...
                  <div className="text text-xs md:text-sm lg:text-base leading-normal space-y-4">
                    <p>
                      Fellows는 단순한 외주 개발사가 아니라, 글로벌 마케팅·기술 전문가 네트워크 와 협력하여 프로젝트를 진행합니다. GTM 전략, SEO 최적화, Google
                      Ads(GAD), Meta Ads(CPAS), Google Analytics(GA4)까지 아우르는 엔드투엔드 디지털 역량을 제공합니다.
                    </p>
                    ...
                    <p className="hidden xl:inline-block">
                      ...
                      <TextHighlighter className={highlightClass} transition={transition} highlightColor={highlightColor} useInViewOptions={inViewOptions}>
                        기업이 더 빠르고 확실하게 시장에서 자리 잡도록 돕습니다.
                      </TextHighlighter>
                    </p>
      ...
      <div className="relative col-span-1 md:ml-5 cursor-none" onClick={() => (showDetail == 2 ? setShowDetail(0) : setShowDetail(2))}>
          ...
          <AnimatePresence>
            {showDetail == 2 && (
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <div className="max-w-lg mx-auto px-8 p-0 text-white">
                  <h1 className="text-2xl md:text-4xl font-medium mb-6 md:mb-12 font-calendas tracking-tight">Cost Efficient</h1>

                  <div className="text text-xs md:text-sm lg:text-base leading-normal space-y-4">
                    <p>Fellows는 하이네켄, 정부기관과의 협업 경험을 보유한 세계 최고 수준의 해외 개발사들과 함께합니다.</p>
                    <p>
                      글로벌 전문성을 바탕으로 하면서도, 국내 SI 대비&nbsp;
                      <TextHighlighter className={highlightClass} transition={transition} highlightColor={highlightColor} useInViewOptions={inViewOptions}>
                        평균 25% 이상 비용 절감
                      </TextHighlighter>
                      이 가능합니다.
                    ...
                    <p>
                      프로젝트 관리부터 견적, 전자 계약, 테스크 관리, 인보이스까지 모든 과정은 자체 개발한 SaaS 플랫폼을 통해&nbsp;
                      <TextHighlighter className={highlightClass} transition={transition} highlightColor={highlightColor} useInViewOptions={inViewOptions}>
                        한눈에, 투명하게, 체계적으로
                      </TextHighlighter>
                      확인할 수 있습니다.
                    ...
                    <p>
                      합리적인 비용과 검증된 품질 — 두 가지 모두 놓치고 싶지 않다면, 답은
                      <TextHighlighter className={highlightClass} transition={transition} highlightColor={highlightColor} useInViewOptions={inViewOptions}>
                        Fellows
                      </TextHighlighter>
                      입니다.
