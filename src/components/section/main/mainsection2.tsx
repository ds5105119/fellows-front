...
const features = [
  {
    ...
    href: "#",
    cta: "더 알아보기",
    className: "col-span-3 lg:col-span-1 ![box-shadow:0_12px_24px_rgba(0,0,0,.0)] bg-white hover:bg-blue-100 transition-colors duration-300 ease-in-out",
    background: (
  ...
  },
  {
    ...
    href: "#",
    cta: "더 알아보기",
    className: "col-span-3 lg:col-span-2 bg-white hover:bg-blue-100 transition-colors duration-300 ease-in-out",
    background: (
  ...
  },
  {
    ...
    className: "col-span-3 lg:col-span-1 bg-white hover:bg-blue-100 transition-colors duration-300 ease-in-out",
    href: "#",
    cta: "더 알아보기",
    background: (
      <div className="absolute right-10 top-10 origin-top-right rounded-md border transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_0%,#000_30%)] group-hover:scale-110">
